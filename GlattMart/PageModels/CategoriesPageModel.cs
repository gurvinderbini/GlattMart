...
{
    public class CategoriesPageModel: FreshMvvm.FreshBasePageModel, INotifyPropertyChanged
    {
        ServiceResponse<string> data = new ServiceResponse<String>();
        Subcategory Category;
        public CategoriesPageModel(Subcategory category)
        {
            Category = category;
            InitialPage();
        }
                ...
                return new Command<Subcategory>(async (dashBoardSelected) =>
                {
                    ...
                    if (data != null)
                    {
                        if (data.Data != null)
                        {
                            ...
                            {
                                await Application.Current.MainPage.Navigation.PushAsync(new SubCategoriesPage(dashBoardSelected));
                            }
                            else
                            {
        ...
        public Command NavigationToShoppingCartCommand
        {
            get
            {
